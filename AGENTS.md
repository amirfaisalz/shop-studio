...
**Always use Bun** (`bun install`, `bun run`, `bun add`, `bun test`, `bun dev`) as the package manager and JavaScript runtime for all operations in this project. Do not use npm, yarn, or pnpm.
...
- **Project:** **shopify-template-builder** (API base `https://8dmyh6j8.ap-southeast.insforge.app`)
